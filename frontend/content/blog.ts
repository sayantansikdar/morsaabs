...
export const posts: Post[] = [
  {
    ...
    author: 'Chef Ramesh Bhatt',
    authorRole: 'Head Chef, Morsaab’s',
    ...
    body: [
      ...
      { type: 'quote', text: 'The seal is not the technique. The seal is what lets the technique work unattended. The technique is knowing what to put in the pot and in what order.', cite: 'Chef Ramesh Bhatt' },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'quote', text: 'People think the secret is a spice. It is almost never a spice. It is a tomato and a timer.', cite: 'Chef Ramesh Bhatt' },
    ],
  },
  {
    ...
    body: [
      ...
      { type: 'quote', text: 'It is not fusion. Fusion is a chef’s decision. This was a community cooking dinner with what the market had.', cite: 'Meera Sundaram' },
    ],
  },
  {
    ...
    body: [
      ...
      { type: 'quote', text: 'A spice box is a set of decisions somebody already made. Learn what each decision was for and you can start making your own.', cite: 'Chef Ramesh Bhatt' },
    ],
  },
  {
    ...
    body: [
      ...
      { type: 'quote', text: 'The best food in Delhi is very rarely the most written-about food in Delhi.', cite: 'Meera Sundaram' },
    ],
  },
]
